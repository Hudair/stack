...
class instagram_activity_model extends MY_Model {
	...
	public function get_activities(){
		...
		$this->db->where("((b.team_id = ".$team_id." AND a.pid = 0 AND b.social_network = 'instagram' AND b.login_type = '2') OR (b.team_id = '".$team_id."' AND a.pid IS NULL  AND b.social_network = 'instagram' AND b.login_type = '2'))");
		switch (post("f")) {
			case 'started':
