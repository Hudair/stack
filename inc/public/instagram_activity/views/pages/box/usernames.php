				...
				<div class="info">
					<div class="input-group box-search-one">
					  	...
					  	<span class="input-group-append">
						    <button class="btn btn-search-username" type="button">
	...
	<div class="m-b-0 list-add-username">
		...
		?>
			<div class="ig-ac-option-item-username">
				<a href="javascript:void(0);" class="remove"><i class="fas fa-times-circle text-danger"></i></a> <a class="name" href="https://www.instagram.com/<?php echo $username_params[0]?>" target="_blank"><?php echo $username_params[0]?></a>
